...
const MobileBlogCard: React.FC<MobileBlogCardProps> = ({ post }) => {
  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute inset-0 translate-x-2 translate-y-2 bg-gradient-to-br from-blue-100 to-indigo-100 dark:from-blue-900/30 dark:to-indigo-900/30 rounded-2xl blur-sm opacity-60 group-hover:opacity-80 transition-all duration-300"></div>
        
        {/* Middle Layer - Adds more depth */}
        <div className="absolute inset-0 translate-x-1 translate-y-1 bg-gradient-to-br from-blue-50 to-cyan-50 dark:from-blue-800/20 dark:via-indigo-800/10 dark:to-cyan-800/20 rounded-2xl opacity-70 group-hover:opacity-90 transition-all duration-300"></div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex space-x-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="cursor-target flex items-center text-xs text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 transition-colors duration-200 font-medium"
                  onClick={handleClick}
                >
              ...
              <div className="w-2 h-2 bg-gradient-to-r from-blue-400 to-indigo-400 rounded-full opacity-60 group-hover:opacity-100 group-hover:scale-125 transition-all duration-300"></div>
            </div>
          </div>
          
          {/* Hover Glow Effect */}
          <div className="absolute inset-0 bg-gradient-to-br from-blue-400/0 via-indigo-400/0 to-cyan-400/0 group-hover:from-blue-400/5 group-hover:via-indigo-400/5 group-hover:to-cyan-400/5 rounded-2xl transition-all duration-500 pointer-events-none"></div>
        </div>
        
        {/* Floating Elements for Extra Visual Interest */}
        <div className="absolute -top-1 -right-1 w-3 h-3 bg-gradient-to-br from-blue-400 to-indigo-400 rounded-full opacity-0 group-hover:opacity-80 group-hover:animate-pulse transition-all duration-300"></div>
        <div className="absolute -bottom-1 -left-1 w-2 h-2 bg-gradient-to-br from-cyan-400 to-blue-400 rounded-full opacity-0 group-hover:opacity-60 group-hover:animate-bounce transition-all duration-300 delay-100"></div>
      </div>
