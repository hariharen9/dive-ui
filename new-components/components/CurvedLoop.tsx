...
const CurvedLoop = ({
  ...
  return (
    ...
    >
      <svg
        className="select-none w-full overflow-visible block aspect-[100/12] text-[6rem] font-bold font-display uppercase leading-none"
      ...
      >
        ...
        {ready && (
          <text xmlSpace="preserve" className={`${className ?? ""}`} fill="url(#gradient)">
