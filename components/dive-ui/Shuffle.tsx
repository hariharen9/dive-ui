...
// Note: SplitText is a GSAP bonus plugin.
...
const Shuffle: React.FC<ShuffleProps> = ({
  ...
  const commonStyle = useMemo(
    ...
    [textAlign, fallbackFont, style, fontSize, color, lineClamp]
  );
  ...
  return React.createElement(Tag, { ref: ref as any, className: classes, style: commonStyle, ...rest }, text);
};
